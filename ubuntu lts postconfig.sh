...
sleep 2
sudo apt-get autoremove rhythmbox gedit gedit-common remmina deja-dup gnome-todo totem
...
sleep 2
sudo apt-get install ubuntu-restricted-extras ffmpeg libavdevice58 sox libsox-fmt-mp3 libsox-fmt-ao libsox-fmt-pulse vlc soundconverter yt-dlp winbind 

echo "Brasero CD/DVD Programm"
sleep 2
...
sleep 2
sudo apt-get install gstreamer1.0-espeak gstreamer1.0-fdkaac gstreamer1.0-plugins-bad gstreamer1.0-plugins-rtp gir1.2-gst-plugins-bad-1.0
...
clear
echo "Nvidia dkms Graphics Driver"
echo ""
sleep 3
sudo apt install nvidia-dkms-515 nvidia-driver-515 nvidia-settings libnvidia-gl-515 libnvidia-gl-515:i386 nvidia-compute-utils-515 nvidia-utils-515 libva-va-gl1 libva-glx2 libclfft2 
clear
...
sudo apt-get update  
sudo apt-get install -y --install-recommends winehq-staging libfaudio0 libvkd3d-shader1 vkd3d-compiler vulkan-validationlayers libgdiplus fonts-wine
clear
